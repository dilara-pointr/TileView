...
public class TileView extends ZoomPanLayout implements
    ...
    private BasicPathView mBasicPathView;
    ...
    public TileView(Context context, AttributeSet attrs, int defStyleAttr ) {
        ...
        mBasicPathView = new BasicPathView(context);
        addView(mBasicPathView);
    ...
    public BasicPathView getBasicPathView() {
        return mBasicPathView;
    }
